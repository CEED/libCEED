...
// Sample runs:
//
//     bpsdmplex -problem bp1 -degree 3
//     bpsdmplex -problem bp2 -ceed /cpu/self -degree 3
//     bpsdmplex -problem bp3 -ceed /gpu/occa -degree 3
//     bpsdmplex -problem bp4 -ceed /cpu/occa -degree 3
