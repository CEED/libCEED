...
// *****************************************************************************
CEED_QFUNCTION int SetupDiff(void *ctx, const CeedInt Q, const CeedScalar *const *in, CeedScalar *const *out) {
  #ifndef M_PI
...
CEED_QFUNCTION int Diff(void *ctx, const CeedInt Q, const CeedScalar *const *in, CeedScalar *const *out) {
