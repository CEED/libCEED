...
// -----------------------------------------------------------------------------
CEED_QFUNCTION(ElasSSNHF)(void *ctx, CeedInt Q, const CeedScalar *const *in,
  ...
  for (CeedInt i=0; i<Q; i++) {
    ...
    const CeedScalar e00 = (grad_u[0][0][i] + grad_u[0][0][i])/2.,
                     e01 = (grad_u[0][1][i] + grad_u[1][0][i])/2.,
                     e02 = (grad_u[0][2][i] + grad_u[2][0][i])/2.,
                     e11 = (grad_u[1][1][i] + grad_u[1][1][i])/2.,
                     e12 = (grad_u[1][2][i] + grad_u[2][1][i])/2.,
                     e22 = (grad_u[2][2][i] + grad_u[2][2][i])/2.;
    // *INDENT-OFF*
...
// -----------------------------------------------------------------------------
CEED_QFUNCTION(ElasSSNHdF)(void *ctx, CeedInt Q, const CeedScalar *const *in,
                           CeedScalar *const *out) {
  // *INDENT-OFF*
  // Inputs
...
// -----------------------------------------------------------------------------
CEED_QFUNCTION(ElasSSNHEnergy)(void *ctx, CeedInt Q,
...
// -----------------------------------------------------------------------------
CEED_QFUNCTION(ElasSSNHDiagnostic)(void *ctx, CeedInt Q,
                                   const CeedScalar *const *in,
                                   CeedScalar *const *out) {
  // *INDENT-OFF*
  // Inputs
