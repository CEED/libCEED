...
PetscErrorCode ProcessPhysics(MPI_Comm comm, Physics phys, Units units) { //TO-DO
  PetscErrorCode ierr;
...
// Process physics options
PetscErrorCode ProcessPhysics_MR(MPI_Comm comm, Physics_MR phys_MR, Units units) { //TO-DO
  PetscErrorCode ierr;
