...
problemData problemOptions[5] = {
  ...
  [ELAS_HYPER_FS] = { 
    ...
    .setupgeofname = SetupGeo_loc,
    .applyfname = HyperFSF_NH_loc,
    .jacobfname = HyperFSdF_NH_loc,
  ...
  [ELAS_HYPER_FS_MR] = { 
    ...
    .diagnostic = HyperFSDiagnostic,
    .setupgeofname = SetupGeo_loc,
    .applyfname = HyperFSF_MR_loc,
    .jacobfname = HyperFSdF_MR_loc,
  ...
  [ELAS_HYPER_FS_GP] = { 
    ...
    .diagnostic = HyperFSDiagnostic,
    .setupgeofname = SetupGeo_loc,
    .applyfname = HyperFSF_GP_loc,
    .jacobfname = HyperFSdF_GP_loc,
