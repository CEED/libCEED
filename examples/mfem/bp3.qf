...
CEED_QFUNCTION int f_build_diff(void *ctx, const CeedInt Q, const CeedScalar *const *in, CeedScalar *const *out) {
...
CEED_QFUNCTION int f_apply_diff(void *ctx, const CeedInt Q, const CeedScalar *const *in, CeedScalar *const *out) {
  BuildContext *bc = (BuildContext *)ctx;
