...
clang -flto=thin -fuse-ld=lld -I../../include -std=c11 -O3 -g  ex1-volume.o -o ex1-volume -Wl,-rpath,/home/alma4974/spur/libCEED/lib -L../../lib -lceed -L../../examples/ceed -lbruhh -lm
