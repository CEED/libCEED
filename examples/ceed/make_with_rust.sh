rustc --crate-type=staticlib --release -Clinker-plugin-lto -Copt-level=3 -C panic=abort ./bruhh.rs
...
# rustc +nightly --crate-type=lib -Clinker-plugin-lto -Copt-level=3 -C panic=abort ./bruhh.rs
