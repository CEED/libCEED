...
PetscErrorCode NS_NEWTONIAN_WAVE(ProblemData *problem, DM dm, void *ctx) {
  ...
  CeedQFunctionContextGetData(problem->apply_freestream.qfunction_context,
                              CEED_MEM_HOST, &freestream_ctx);
  ...
  CeedQFunctionContextRestoreData(problem->apply_vol_rhs.qfunction_context,
                                  &newtonian_ig_ctx);
  CeedQFunctionContextRestoreData(problem->apply_freestream.qfunction_context,
                                  &freestream_ctx);
