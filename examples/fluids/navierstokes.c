...
//TESTARGS(name="euler_t1") -ceed {ceed_resource} -test -problem euler_vortex -dm_plex_box_faces 1,1,2 -units_meter 1e-3 -lx 125 -ly 125 -lz 1 -ts_dt 1e-3 -problem_euler_mean_velocity -.4,1.6,0 -vortex_strength 3 -euler_test t1 -compare_final_state_atol 1E-11 -compare_final_state_filename examples/fluids/tests-output/fluids-navierstokes-euler-t1.bin
//TESTARGS(name="euler_t2") -ceed {ceed_resource} -test -problem euler_vortex -dm_plex_box_faces 1,1,2 -units_meter 1e-3 -lx 125 -ly 125 -lz 1 -ts_dt 1e-3 -problem_euler_mean_velocity -.4,1.6,0 -vortex_strength 3 -euler_test t2 -compare_final_state_atol 1E-11 -compare_final_state_filename examples/fluids/tests-output/fluids-navierstokes-euler-t2.bin
//TESTARGS(name="euler_t3") -ceed {ceed_resource} -test -problem euler_vortex -dm_plex_box_faces 1,1,2 -units_meter 1e-3 -lx 125 -ly 125 -lz 1 -ts_dt 1e-3 -problem_euler_mean_velocity -.4,1.6,0 -vortex_strength 3 -euler_test t3 -compare_final_state_atol 1E-11 -compare_final_state_filename examples/fluids/tests-output/fluids-navierstokes-euler-t3.bin
//TESTARGS(name="euler_t4") -ceed {ceed_resource} -test -problem euler_vortex -dm_plex_box_faces 1,1,2 -units_meter 1e-3 -lx 125 -ly 125 -lz 1 -ts_dt 1e-3 -problem_euler_mean_velocity -.4,1.6,0 -vortex_strength 3 -euler_test t4 -compare_final_state_atol 1E-11 -compare_final_state_filename examples/fluids/tests-output/fluids-navierstokes-euler-t4.bin
