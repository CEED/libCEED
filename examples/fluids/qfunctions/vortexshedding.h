...
// *****************************************************************************
CEED_QFUNCTION_HELPER int ICsVortexshedding(void *ctx, CeedInt Q, const CeedScalar *const *in, CeedScalar *const *out, StateToQi_t StateToQi) {
  // Inputs
...
CEED_QFUNCTION(ICsVortexshedding_Conserv)(void *ctx, CeedInt Q, const CeedScalar *const *in, CeedScalar *const *out) {
  return ICsVortexshedding(ctx, Q, in, out, StateToU);
}

CEED_QFUNCTION(ICsVortexshedding_Prim)(void *ctx, CeedInt Q, const CeedScalar *const *in, CeedScalar *const *out) {
