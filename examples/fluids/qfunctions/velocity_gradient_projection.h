...
CEED_QFUNCTION_HELPER int VelocityGradientProjection(void *ctx, CeedInt Q, const CeedScalar *const *in, CeedScalar *const *out,
...
CEED_QFUNCTION(VelocityGradientProjection_Conserv)(void *ctx, CeedInt Q, const CeedScalar *const *in, CeedScalar *const *out) {
  return VelocityGradientProjection(ctx, Q, in, out, StateFromU, StateFromU_fwd);
}

CEED_QFUNCTION(VelocityGradientProjection_Prim)(void *ctx, CeedInt Q, const CeedScalar *const *in, CeedScalar *const *out) {
  return VelocityGradientProjection(ctx, Q, in, out, StateFromY, StateFromY_fwd);
}
