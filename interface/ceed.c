...
int CeedInit(const char *resource, Ceed *ceed) {
  ...
  FOffset f_offsets[] = {
    ...
    CEED_FTABLE_ENTRY(CeedVector, HasValidArrayOfPrecision),
    CEED_FTABLE_ENTRY(CeedVector, HasBorrowedArrayOfType),
    CEED_FTABLE_ENTRY(CeedVector, HasBorrowedArrayOfTypeAndPrecision),
    CEED_FTABLE_ENTRY(CeedVector, SetArray),
    CEED_FTABLE_ENTRY(CeedVector, SetArrayTyped),
    CEED_FTABLE_ENTRY(CeedVector, TakeArray),
    CEED_FTABLE_ENTRY(CeedVector, TakeArrayTyped),
    CEED_FTABLE_ENTRY(CeedVector, SetValue),
    CEED_FTABLE_ENTRY(CeedVector, GetArray),
    CEED_FTABLE_ENTRY(CeedVector, GetArrayTyped),
    CEED_FTABLE_ENTRY(CeedVector, GetArrayRead),
    CEED_FTABLE_ENTRY(CeedVector, GetArrayReadTyped),
    CEED_FTABLE_ENTRY(CeedVector, GetArrayWrite),
    CEED_FTABLE_ENTRY(CeedVector, GetArrayWriteTyped),
