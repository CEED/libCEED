...
int CeedInit(const char *resource, Ceed *ceed) {
  ...
  foffset foffsets[] = {
    ...
    CEED_FTABLE_ENTRY(Ceed, UserContextCreate),
    ...
    CEED_FTABLE_ENTRY(CeedUserContext, SetData),
    CEED_FTABLE_ENTRY(CeedUserContext, GetData),
    CEED_FTABLE_ENTRY(CeedUserContext, RestoreData),
    CEED_FTABLE_ENTRY(CeedUserContext, Destroy),
