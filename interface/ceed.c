...
int CeedInit(const char *resource, Ceed *ceed) {
  ...
  FOffset f_offsets[] = {
      ...
      CEED_FTABLE_ENTRY(Ceed, ElemRestrictionCreateCurlOriented),
      CEED_FTABLE_ENTRY(Ceed, ElemRestrictionCreateBlocked),
      CEED_FTABLE_ENTRY(Ceed, ElemRestrictionCreateBlockedOriented),
      CEED_FTABLE_ENTRY(Ceed, ElemRestrictionCreateBlockedCurlOriented),
