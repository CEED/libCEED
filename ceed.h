...
CEED_EXTERN int CeedErrorReturn(Ceed, const char *, int, const char *, int, const char *,
                                va_list);
CEED_EXTERN int CeedErrorAbort(Ceed, const char *, int, const char *, int, const char *,
                               va_list);
...
CEED_EXTERN int CeedVectorSetArray(CeedVector vec, CeedMemType mtype, CeedCopyMode cmode,
                                   CeedScalar *array);
...
CEED_EXTERN int CeedElemRestrictionCreate(Ceed ceed, CeedInt nelements, CeedInt esize,
    CeedInt ndof, CeedMemType mtype, CeedCopyMode cmode, const CeedInt *indices,
    CeedElemRestriction *r);
CEED_EXTERN int CeedElemRestrictionCreateBlocked(Ceed ceed, CeedInt nelements, CeedInt esize,
    CeedInt blocksize, CeedMemType mtype, CeedCopyMode cmode, CeedInt *blkindices,
    CeedElemRestriction *r);
CEED_EXTERN int CeedElemRestrictionApply(CeedElemRestriction r, CeedTransposeMode tmode,
...
CEED_EXTERN int CeedBasisCreateTensorH1Lagrange(Ceed ceed, CeedInt dim, CeedInt ndof,
    CeedInt degree, CeedInt Q, CeedQuadMode qmode, CeedBasis *basis);
CEED_EXTERN int CeedBasisCreateTensorH1(Ceed ceed, CeedInt dim, CeedInt ndof, CeedInt P1d,
                                        CeedInt Q1d, const CeedScalar *interp1d, const CeedScalar *grad1d, const CeedScalar *qref1d,
                                        const CeedScalar *qweight1d, CeedBasis *basis);
CEED_EXTERN int CeedBasisView(CeedBasis basis, FILE *stream);
CEED_EXTERN int CeedBasisApply(CeedBasis basis, CeedTransposeMode tmode, CeedEvalMode emode,
...
CEED_EXTERN int CeedQFunctionCreateInterior(Ceed ceed, CeedInt vlength, CeedInt nfields,
...
CEED_EXTERN int CeedOperatorCreate(Ceed ceed, CeedElemRestriction r, CeedBasis b,
                                   CeedQFunction qf, CeedQFunction dqf, CeedQFunction dqfT, CeedOperator *op);
CEED_EXTERN int CeedOperatorGetQData(CeedOperator op, CeedVector *qdata);
CEED_EXTERN int CeedOperatorApply(CeedOperator op, CeedVector qdata, CeedVector ustate,
                                  CeedVector residual, CeedRequest *request);
CEED_EXTERN int CeedOperatorApplyJacobian(CeedOperator op, CeedVector qdata, CeedVector ustate,
    CeedVector dustate, CeedVector dresidual, CeedRequest *request);
