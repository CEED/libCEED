...
CEED_EXTERN int CeedQFunctionCreateInteriorFromGallery(Ceed ceed,
    CeedInt vlength, char* spec,
    CeedQFunction *qf);
...
CEED_EXTERN int CeedOperatorCreateFromGallery(Ceed ceed, char *spec,
    CeedOperator *op);
