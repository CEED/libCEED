...
CEED_EXTERN int CeedQFunctionContextRegisterInt32(CeedQFunctionContext ctx, const char *field_name, size_t field_offset, size_t num_values,
                                                  const char *field_description);
CEED_EXTERN int CeedQFunctionContextRegisterInt64(CeedQFunctionContext ctx, const char *field_name, size_t field_offset, size_t num_values,
                                                  const char *field_description);
...
CEED_EXTERN int  CeedOperatorSetContextInt64(CeedOperator op, CeedContextFieldLabel field_label, int64_t *values);
CEED_EXTERN int  CeedOperatorGetContextInt64Read(CeedOperator op, CeedContextFieldLabel field_label, size_t *num_values, const int64_t **values);
CEED_EXTERN int  CeedOperatorRestoreContextInt64Read(CeedOperator op, CeedContextFieldLabel field_label, const int64_t **values);
