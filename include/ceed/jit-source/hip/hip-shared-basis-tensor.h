...
extern "C"  __launch_bounds__(BASIS_INTERP_BLOCK_SIZE)
            __global__ void Interp(const CeedInt num_elem,
                                   const CeedScalar *d_interp_1d,
...
extern "C"  __launch_bounds__(BASIS_INTERP_BLOCK_SIZE)
            __global__ void InterpTranspose(const CeedInt num_elem,
                                            const CeedScalar *d_interp_1d,
                                            const CeedScalar *__restrict__ d_U,
                                            CeedScalar *__restrict__ d_V) {
  extern __shared__ CeedScalar slice[];
...
extern "C" __launch_bounds__(BASIS_GRAD_BLOCK_SIZE)
           __global__ void Grad(const CeedInt num_elem,
                                const CeedScalar *d_interp_1d,
                                const CeedScalar *d_grad_1d,
                                const CeedScalar *__restrict__ d_U,
                                CeedScalar *__restrict__ d_V) {
  extern __shared__ CeedScalar slice[];
...
extern "C" __launch_bounds__(BASIS_GRAD_BLOCK_SIZE)
           __global__ void GradTranspose(const CeedInt num_elem,
                                         const CeedScalar *d_interp_1d, 
                                         const CeedScalar *d_grad_1d,
                                         const CeedScalar *__restrict__ d_U,
                                         CeedScalar *__restrict__ d_V) {
