...
magma_weight_2d_device(const T* sTweight, T rV[DIM_][NCOMP_][Q_], const int tx) 
{
    // Assumptions
...
//////////////////////////////////////////////////////////////////////////////////////////
extern "C" __launch_bounds__(MAGMA_BASIS_BOUNDS(Q, MAGMA_MAXTHREADS_2D)) __global__ void
magma_weight_2d_kernel(const CeedScalar *dqweight1d, CeedScalar *dV, const int v_stride, const int nelem)
{
