...
# CeedElemTopology
LINE = lib.CEED_FE_TOPO_LINE
TRIANGLE = lib.CEED_FE_TOPO_TRIANGLE
QUAD = lib.CEED_FE_TOPO_QUAD
TET = lib.CEED_FE_TOPO_TET
PYRAMID = lib.CEED_FE_TOPO_PYRAMID
PRISM = lib.CEED_FE_TOPO_PRISM
HEX = lib.CEED_FE_TOPO_HEX
