...
**/
CEED_INTERN int CeedQFunctionRegister_ScaleScalar(void) { return CeedQFunctionRegister("Scalar Scale", ScaleScalar_loc, 1, ScaleScalar, CeedQFunctionInit_ScaleScalar); }
