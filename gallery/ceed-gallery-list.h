...
MACRO(CeedQFunctionRegister_VectorMassApply)
...
MACRO(CeedQFunctionRegister_VectorPoisson1DApply)
MACRO(CeedQFunctionRegister_VectorPoisson2DApply)
MACRO(CeedQFunctionRegister_VectorPoisson3DApply)
