...
**/
static int CeedQFunctionInit_Restrict2(Ceed ceed, const char *requested,
                                       CeedQFunction qf) {
  int ierr;

  // Check QFunction name
  const char *name = "Restrict2";
...
static void Register(void) {
  CeedQFunctionRegister("Restrict2", Multigrid2_loc, 1, Multigrid2,
                        CeedQFunctionInit_Restrict2);
}
