...
static int CeedInit_Ref(const char *resource, Ceed ceed) {
  ...
  CeedCallBackend(CeedSetBackendFunction(ceed, "Ceed", ceed, "ElemRestrictionCreateCurlOriented", CeedElemRestrictionCreateCurlOriented_Ref));
  CeedCallBackend(CeedSetBackendFunction(ceed, "Ceed", ceed, "ElemRestrictionCreateBlocked", CeedElemRestrictionCreate_Ref));
  CeedCallBackend(CeedSetBackendFunction(ceed, "Ceed", ceed, "ElemRestrictionCreateBlockedOriented", CeedElemRestrictionCreateOriented_Ref));
  CeedCallBackend(CeedSetBackendFunction(ceed, "Ceed", ceed, "ElemRestrictionCreateBlockedCurlOriented", CeedElemRestrictionCreateCurlOriented_Ref));
