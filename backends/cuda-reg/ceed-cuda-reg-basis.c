...
inline __device__ void Contract1d(const real *A, const real *B,
                                  int nA1, int nB1, int nB2, real *T) {
...
//------------------------------------------------------------------------------
// 1D interpolate to quadratue points
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// 1D derivative at quadrature points
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// 2D tensor contraction
//------------------------------------------------------------------------------
inline __device__ void Contract2d(const real *A, const real *B,
                                  int nA1, int nA2, int nB1, int nB2, real *T) {
...
//------------------------------------------------------------------------------
// 2D transpose tensor contraction
//------------------------------------------------------------------------------
...
__device__ void weight2d(const CeedInt nelem, const CeedScalar *qweight1d,
  ...
  for (int e = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (int i = 0; i < Q1D; ++i)
      for (int j = 0; j < Q1D; ++j) {
        const int ind = e*Q1D*Q1D + i + j*Q1D;
        w[ind] = w1d[i]*w1d[j];
      }
  }
}
...
//------------------------------------------------------------------------------
inline __device__ void Contract3d(const real *A, const real *B, int nA1,
                                  int nA2, int nA3, int nB1, int nB2, real *T) {
...
//------------------------------------------------------------------------------
// 3D transpose tensor contraction
//------------------------------------------------------------------------------
inline __device__ void ContractTranspose3d(const real *A, const real *B,
    int nA1, int nA2, int nA3, int nB1, int nB2, real *T) {
