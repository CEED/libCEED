                ...
                magma_int_t nelem, magma_queue_t queue)
{
    ...
    if( nthreads > nthreads_max || shmem > shmem_max ) {
        ...
        (dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride);
                ...
                magma_int_t nelem, magma_queue_t queue)
{
    ...
    switch(ncomp) {
        case 1: launch_failed = magma_grad_1d_kernel_driver<CeedScalar,1,P,Q>(dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case 2: launch_failed = magma_grad_1d_kernel_driver<CeedScalar,2,P,Q>(dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case 3: launch_failed = magma_grad_1d_kernel_driver<CeedScalar,3,P,Q>(dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
                ...
                magma_int_t nelem, magma_queue_t queue)
{
    magma_int_t launch_failed = 0;
    switch(Q) {
        case  1: launch_failed = magma_grad_1d_ncomp<P, 1>(ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  2: launch_failed = magma_grad_1d_ncomp<P, 2>(ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  3: launch_failed = magma_grad_1d_ncomp<P, 3>(ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  4: launch_failed = magma_grad_1d_ncomp<P, 4>(ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  5: launch_failed = magma_grad_1d_ncomp<P, 5>(ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  6: launch_failed = magma_grad_1d_ncomp<P, 6>(ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  7: launch_failed = magma_grad_1d_ncomp<P, 7>(ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
                ...
                magma_int_t nelem, magma_queue_t queue)
{
    magma_int_t launch_failed = 0;
    switch(P) {
        case  1: launch_failed = magma_grad_1d_ncomp_q< 1>(Q, ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  2: launch_failed = magma_grad_1d_ncomp_q< 2>(Q, ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  3: launch_failed = magma_grad_1d_ncomp_q< 3>(Q, ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  4: launch_failed = magma_grad_1d_ncomp_q< 4>(Q, ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  5: launch_failed = magma_grad_1d_ncomp_q< 5>(Q, ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  6: launch_failed = magma_grad_1d_ncomp_q< 6>(Q, ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
        case  7: launch_failed = magma_grad_1d_ncomp_q< 7>(Q, ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, queue); break;
