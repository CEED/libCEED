                ...
                magma_int_t nelem, magma_int_t maxthreads, magma_queue_t queue)
{
    ...
    switch (ncomp) {
        case 1: 
          ...
          (dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, maxthreads, queue); 
          break;
        case 2: 
                ...
                magma_int_t nelem, magma_int_t maxthreads, magma_queue_t queue)
{
    ...
    switch (Q) {
        case  1: 
          ...
          (ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, maxthreads, queue); 
          break;
        case  2: 
                ...
                magma_int_t nelem, magma_int_t maxthreads, magma_queue_t queue)
{
    ...
    switch (P) {
        case  1: 
          ...
          (Q, ncomp, dTgrad, transT, dU, u_elstride, u_compstride, dV, v_elstride, v_compstride, nelem, maxthreads, queue); 
          break;
        case  2: 
