...
magma_grad_generic_kernel( 
    ...
    const double *dU, const int u_elstride, const int u_compstride, const int u_dimstride, 
          double *dV, const int v_elstride, const int v_compstride, const int v_dimstride, 
    const int dim_id )
{
                ...
                magma_queue_t queue)
{
    ...
    if( nthreads > 1024 ) {
        ...
        magma_grad_generic_kernel<P, Q><<<grid, threads, shmem, magma_queue_get_cuda_stream(queue)>>>
    ...
    magma_queue_t queue)
{
    ...
    switch(Q){
        case  1: launch_failed = magma_grad_generic_kernel_driver<P, 1>( dim, ncomp, nqpt, dinterp1d, dgrad1d, transT, dU, u_elstride, u_compstride, u_dimstride, dV, v_elstride, v_compstride, v_dimstride, dim_id, nelem, queue); break;
        case  2: launch_failed = magma_grad_generic_kernel_driver<P, 2>( dim, ncomp, nqpt, dinterp1d, dgrad1d, transT, dU, u_elstride, u_compstride, u_dimstride, dV, v_elstride, v_compstride, v_dimstride, dim_id, nelem, queue); break;
        case  3: launch_failed = magma_grad_generic_kernel_driver<P, 3>( dim, ncomp, nqpt, dinterp1d, dgrad1d, transT, dU, u_elstride, u_compstride, u_dimstride, dV, v_elstride, v_compstride, v_dimstride, dim_id, nelem, queue); break;
        case  4: launch_failed = magma_grad_generic_kernel_driver<P, 4>( dim, ncomp, nqpt, dinterp1d, dgrad1d, transT, dU, u_elstride, u_compstride, u_dimstride, dV, v_elstride, v_compstride, v_dimstride, dim_id, nelem, queue); break;
        case  5: launch_failed = magma_grad_generic_kernel_driver<P, 5>( dim, ncomp, nqpt, dinterp1d, dgrad1d, transT, dU, u_elstride, u_compstride, u_dimstride, dV, v_elstride, v_compstride, v_dimstride, dim_id, nelem, queue); break;
        case  6: launch_failed = magma_grad_generic_kernel_driver<P, 6>( dim, ncomp, nqpt, dinterp1d, dgrad1d, transT, dU, u_elstride, u_compstride, u_dimstride, dV, v_elstride, v_compstride, v_dimstride, dim_id, nelem, queue); break;
        case  7: launch_failed = magma_grad_generic_kernel_driver<P, 7>( dim, ncomp, nqpt, dinterp1d, dgrad1d, transT, dU, u_elstride, u_compstride, u_dimstride, dV, v_elstride, v_compstride, v_dimstride, dim_id, nelem, queue); break;
        case  8: launch_failed = magma_grad_generic_kernel_driver<P, 8>( dim, ncomp, nqpt, dinterp1d, dgrad1d, transT, dU, u_elstride, u_compstride, u_dimstride, dV, v_elstride, v_compstride, v_dimstride, dim_id, nelem, queue); break;
        case  9: launch_failed = magma_grad_generic_kernel_driver<P, 9>( dim, ncomp, nqpt, dinterp1d, dgrad1d, transT, dU, u_elstride, u_compstride, u_dimstride, dV, v_elstride, v_compstride, v_dimstride, dim_id, nelem, queue); break;
        case 10: launch_failed = magma_grad_generic_kernel_driver<P,10>( dim, ncomp, nqpt, dinterp1d, dgrad1d, transT, dU, u_elstride, u_compstride, u_dimstride, dV, v_elstride, v_compstride, v_dimstride, dim_id, nelem, queue); break;
