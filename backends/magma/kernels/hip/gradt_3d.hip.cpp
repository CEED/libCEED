                ...
                magma_int_t nelem, magma_queue_t queue)
{
    ...
    if ( (nthreads*ntcol) > nthreads_max || shmem > shmem_max ) {
        ...
        hipLaunchKernelGGL(HIP_KERNEL_NAME(magma_gradt_3d_kernel<T,TC,NCOMP,P,Q,MAXPQ>), dim3(grid), dim3(threads), shmem, magma_queue_get_hip_stream(queue), dinterp1d, dgrad1d, transT, dU, estrdU, cstrdU, dstrdU, dV, estrdV, cstrdV, dstrdV, nelem);
                ...
                magma_int_t nelem, magma_queue_t queue)
{
    ...
    switch (ncomp) {
        case 1: 
          launch_failed = magma_gradt_3d_kernel_driver<CeedScalar,double,1,P,Q>
          (dinterp1d, dgrad1d, transT, dU, estrdU, cstrdU, dstrdU, dV, estrdV, cstrdV, dstrdV, nelem, queue); 
          break;
        case 2: 
          launch_failed = magma_gradt_3d_kernel_driver<CeedScalar,double,2,P,Q>
          (dinterp1d, dgrad1d, transT, dU, estrdU, cstrdU, dstrdU, dV, estrdV, cstrdV, dstrdV, nelem, queue); 
          break;
        case 3: 
          launch_failed = magma_gradt_3d_kernel_driver<CeedScalar,double,3,P,Q>
          (dinterp1d, dgrad1d, transT, dU, estrdU, cstrdU, dstrdU, dV, estrdV, cstrdV, dstrdV, nelem, queue); 
          break;
