...
// TODO - This should be replaced with fallthrough to a ref ceed

// Contracts on the middle index
// NOTRANSPOSE: V_ajc = T_jb U_abc
// TRANSPOSE:   V_ajc = T_bj U_abc
// If Add != 0, "=" is replaced by "+="
static int CeedTensorContract_MagmaCPU(Ceed ceed,
                                       CeedInt A, CeedInt B, CeedInt C,
                                       CeedInt J, const CeedScalar *t,
...
static int CeedBasisApply_MagmaCPU(CeedBasis basis, CeedTransposeMode tmode,
                                   CeedEvalMode emode,
