...
int magma_dgemm_nontensor(magma_trans_t transA, magma_trans_t transB, magma_int_t m, magma_int_t n, magma_int_t k, double alpha, const double *dA,
  ...
  if (n1 == n) {
    ...
    if (use_magmablas) {
      magmablas_dgemm_batched_strided(transA, transB, m, n1, k, alpha, dA, ldda, strideA, dB, lddb, strideB, beta, dC, lddc, strideC, batchCount,
                                      queue);
      ...
      hipblasDgemmStridedBatched(magma_queue_get_hipblas_handle(queue), hipblas_trans_const(transA), hipblas_trans_const(transB), (int)m, (int)n1,
                                 (int)k, &alpha, (const double *)dA, (int)ldda, strideA, (const double *)dB, (int)lddb, strideB, &beta, dC, (int)lddc,
                                 strideC, (int)batchCount);

      // cleanup
      if (n2 > 0) {
        hipblasDgemmStridedBatched(magma_queue_get_hipblas_handle(queue), hipblas_trans_const(transA), hipblas_trans_const(transB), (int)m, (int)n2,
...
int magma_dgemm_nontensor(magma_trans_t transA, magma_trans_t transB, magma_int_t m, magma_int_t n, magma_int_t k, double alpha, const double *dA,
  ...
  if (n1 == n) {
    ...
    if (use_magmablas) {
      ...
      cublasDgemmStridedBatched(magma_queue_get_cublas_handle(queue), cublas_trans_const(transA), cublas_trans_const(transB), (int)m, (int)n1, (int)k,
                                &alpha, (const double *)dA, (int)ldda, strideA, (const double *)dB, (int)lddb, strideB, &beta, dC, (int)lddc, strideC,
                                (int)batchCount);

      // cleanup
      if (n2 > 0) {
        cublasDgemmStridedBatched(magma_queue_get_cublas_handle(queue), cublas_trans_const(transA), cublas_trans_const(transB), (int)m, (int)n2,
                                  (int)k, &alpha, (const double *)dA, (int)ldda, strideA, (const double *)dB + batchCount * strideB, (int)lddb,
                                  strideB, &beta, dC + batchCount * strideC, (int)lddc, strideC, 1);
      }
    }
