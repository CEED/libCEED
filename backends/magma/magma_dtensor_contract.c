...
void magma_dtensor_contract(Ceed ceed, CeedInt A, CeedInt B, CeedInt C,
                            CeedInt J, const CeedScalar *dT,
  ...
  magma_dset_pointer(dT_array, (double *)dT, ldt, 0, 0,      0, batchCount,
                     queue);
  magma_dset_pointer(dU_array, (double *)dU, ldu, 0, 0, ldu*Un, batchCount,
                     queue);
  magma_dset_pointer(dV_array, (double *)dV, ldv, 0, 0, ldv*Vn, batchCount,
                     queue);
  magmablas_dgemm_batched(transU, transT, C, J, B, alpha,
                          (double const * const *)dU_array, ldu,
