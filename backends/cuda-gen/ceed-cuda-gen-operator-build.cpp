...
// Restriction
//------------------------------------------------------------------------------
static int CeedOperatorBuildKernelRestriction_Cuda_gen(std::ostringstream &code, CeedOperator_Cuda_gen *data, const char *tab, CeedInt i,
...
// Basis
//------------------------------------------------------------------------------
static int CeedOperatorBuildKernelBasis_Cuda_gen(std::ostringstream &code, CeedOperator_Cuda_gen *data, const char *tab, CeedInt i,
...
// QFunction
//------------------------------------------------------------------------------
static int CeedOperatorBuildKernelQFunction_Cuda_gen(std::ostringstream &code, CeedOperator_Cuda_gen *data, const char *tab, CeedInt max_dim,
...
extern "C" int CeedOperatorBuildKernel_Cuda_gen(CeedOperator op, bool *is_good_build) {
  ...
  for (CeedInt i = 0; i < num_input_fields; i++) {
    ...
    // ---- Restriction
    CeedCallBackend(CeedOperatorBuildKernelRestriction_Cuda_gen(code, data, "", f, field_rstr_in_buffer, op_input_fields[f], qf_input_fields[f],
                                                                max_dim, Q_1d, true, is_all_tensor, is_at_points, use_3d_slices));

    // ---- Basis action
    CeedCallBackend(CeedOperatorBuildKernelBasis_Cuda_gen(code, data, "", f, op_input_fields[f], qf_input_fields[f], max_dim, Q_1d, true,
                                                          is_all_tensor, is_at_points, use_3d_slices));
  }

  // -- Q function
  CeedCallBackend(CeedOperatorBuildKernelQFunction_Cuda_gen(code, data, "", max_dim, max_num_points, num_input_fields, op_input_fields,
  ...
  for (CeedInt i = 0; i < num_output_fields; i++) {
    ...
    // ---- Restriction
    CeedCallBackend(CeedOperatorBuildKernelRestriction_Cuda_gen(code, data, "", i, NULL, op_output_fields[i], qf_output_fields[i], max_dim, Q_1d,
