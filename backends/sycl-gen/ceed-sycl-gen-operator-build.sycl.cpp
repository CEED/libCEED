...
// #include "../sycl-ref/ceed-sycl-ref.h"
// #include "../sycl-shared/ceed-sycl-shared.h"
// #include "../sycl/ceed-sycl-compile.h"
// #include "ceed-sycl-gen.h"

// //------------------------------------------------------------------------------
// // Calculate the block size used for launching the operator kernel
// //------------------------------------------------------------------------------
// extern "C" int BlockGridCalculate_Sycl_gen(const CeedInt dim, const CeedInt num_elem, const CeedInt P_1d, const CeedInt Q_1d, CeedInt *block_sizes) {
...
//   CeedBasis                basis;
//   CeedBasis_Sycl_shared    *basis_data;
//   CeedElemRestriction      Erestrict;
//   CeedElemRestriction_Sycl *restr_data;
...
//   operator_name = "CeedKernelSyclGenOperator_" + q_function_name;
...
//        << "(CeedInt num_elem, void* ctx, FieldsInt_Sycl indices, Fields_Sycl fields, Fields_Sycl B, Fields_Sycl G, CeedScalar* W) {\n";
//   for (CeedInt i = 0; i < num_input_fields; i++) {
//     CeedCallBackend(CeedQFunctionFieldGetEvalMode(qf_input_fields[i], &eval_mode));
...
//   CeedCallBackend(BlockGridCalculate_Sycl_gen(dim, num_elem, data->max_P_1d, Q_1d, block_sizes));
//   CeedCallBackend(CeedCompileSycl(ceed, code.str().c_str(), &data->module, 2, "T_1D", block_sizes[0], "BLOCK_SIZE",
//                                  block_sizes[0] * block_sizes[1] * block_sizes[2]));
//   CeedCallBackend(CeedGetKernelSycl(ceed, data->module, operator_name.c_str(), &data->op));
