...
#ifdef CEED_USE_OCCA
  // General mode
  CeedRegister("/*/occa", CeedInit_Occa, 270);
  // CPU Modes
  CeedRegister("/cpu/self/occa", CeedInit_Occa, 260);
  CeedRegister("/cpu/openmp/occa", CeedInit_Occa, 250);
  // GPU Modes
  CeedRegister("/gpu/dpcpp/occa", CeedInit_Occa, 240);
  CeedRegister("/gpu/opencl/occa", CeedInit_Occa, 230);
  CeedRegister("/gpu/hip/occa", CeedInit_Occa, 220);
  return CeedRegister("/gpu/cuda/occa", CeedInit_Occa, 210);
#else
  // General mode
  CeedDebugEnv("Weak Register   : %s", "/*/occa");
  CeedRegister("/*/occa", CeedInit_Uncompiled, 270);
  // CPU Modes
  CeedDebugEnv("Weak Register   : %s", "/cpu/self/occa");
  CeedRegister("/cpu/self/occa", CeedInit_Uncompiled, 260);
  CeedDebugEnv("Weak Register   : %s", "/cpu/openmp/occa");
  CeedRegister("/cpu/openmp/occa", CeedInit_Uncompiled, 250);
  // GPU Modes
  CeedDebugEnv("Weak Register   : %s", "/gpu/dpcpp/occa");
  CeedRegister("/gpu/dpcpp/occa", CeedInit_Uncompiled, 240);
  CeedDebugEnv("Weak Register   : %s", "/gpu/opencl/occa");
  CeedRegister("/gpu/opencl/occa", CeedInit_Uncompiled, 230);
  CeedDebugEnv("Weak Register   : %s", "/gpu/hip/occa");
  CeedRegister("/gpu/hip/occa", CeedInit_Uncompiled, 220);
  CeedDebugEnv("Weak Register   : %s", "/gpu/cuda/occa");
  return CeedRegister("/gpu/cuda/occa", CeedInit_Uncompiled, 210);
#endif
}
