...
MACRO(CeedRegister_Sycl, 2, "/gpu/sycl/ref", "/cpu/sycl/ref")
MACRO(CeedRegister_Sycl_Gen, 1, "/gpu/sycl/gen")
MACRO(CeedRegister_Sycl_Shared, 2, "/gpu/sycl/shared", "/cpu/sycl/shared")
