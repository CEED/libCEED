...
LLMs may be used for to aid the development of code for pull requests (PR); however, the individual submitting the PR must adhere to the Developer's Certificate of Origin and is ultimately responsible for the content in the PR.
