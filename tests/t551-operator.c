...
int main(int argc, char **argv) {
  ...
  CeedOperatorSetField(op_mass_f, "qdata", elem_restr_qd_i, CEED_BASIS_COLLOCATED,
                       q_data);
  CeedOperatorSetField(op_mass_f, "u", elem_restr_u_f, basis_f,
                       CEED_VECTOR_ACTIVE);
  CeedOperatorSetField(op_mass_f, "v", elem_restr_u_f, basis_f,
                       CEED_VECTOR_ACTIVE);
  ...
  CeedOperatorMultigridLevelCreate(op_mass_f, p_mult_fine, elem_restr_u_c,
                                   basis_c, &op_mass_c, &op_prolong, &op_restrict);
