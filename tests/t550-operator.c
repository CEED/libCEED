/// @file
/// Test creation, action, and destruction for mass matrix operator with multigrid level
/// \test Test creation, action, and destruction for mass matrix operator with multigrid level
#include <ceed.h>
#include <stdlib.h>
#include <math.h>
