...
int main(int argc, char **argv) {
  ...
  CeedOperatorSetField(op_diff, "u", elem_restriction_u, basis_u, CEED_VECTOR_ACTIVE);
  CeedOperatorSetField(op_diff, "v", elem_restriction_u, basis_u, CEED_VECTOR_ACTIVE);
