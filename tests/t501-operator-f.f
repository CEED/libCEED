...
!-----------------------------------------------------------------------
      ...
      call ceedelemrestrictioncreate(ceed,nelem,2,nx,1,ceed_mem_host,ceed_use_pointer,indx,erestrictx,err)
      call ceedelemrestrictioncreateidentity(ceed,nelem,2,2*nelem,1,erestrictxi,err)
      ...
      call ceedelemrestrictioncreate(ceed,nelem,p,nu,1,ceed_mem_host,ceed_use_pointer,indu,erestrictu,err)
      call ceedelemrestrictioncreateidentity(ceed,nelem,q,q*nelem,1,erestrictui,err)
