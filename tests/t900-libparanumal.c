...
int main(int argc, char **argv) {
  ...
  CeedOperatorSetField(op, "ggeo", ErestrictId, CEED_NOTRANSPOSE,
                       CEED_BASIS_COLLOCATED, ggeo);
  CeedOperatorSetField(op, "S"   , ErestrictId, CEED_NOTRANSPOSE,
                       CEED_BASIS_COLLOCATED, S);
  CeedOperatorSetField(op, "MM"  , ErestrictId, CEED_NOTRANSPOSE,
                       CEED_BASIS_COLLOCATED, MM);
  CeedOperatorSetField(op, "q"   , Erestrictq , CEED_NOTRANSPOSE,
                       bq, CEED_VECTOR_ACTIVE);
  CeedOperatorSetField(op, "Aq"  , Erestrictq , CEED_NOTRANSPOSE,
                       bq, CEED_VECTOR_ACTIVE);
