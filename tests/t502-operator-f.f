...
!-----------------------------------------------------------------------
      ...
      call ceedelemrestrictioncreate(ceed,nelem,p,nu,2,ceed_mem_host,ceed_use_pointer,indu,erestrictu,err)
     ...
     &//':mass'//char(0),qf_mass,err)
      ...
      call ceedoperatorsetfield(op_mass,'u',erestrictu,ceed_transpose,bu,ceed_vector_active,err)
      call ceedoperatorsetfield(op_mass,'v',erestrictu,ceed_transpose,bu,ceed_vector_active,err)
